    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getUserDataReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if(!image.equals("default_image_profile"))

                    Picasso.get().load(image).networkPolicy(NetworkPolicy.OFFLINE).placeholder(R.drawable.defualt_image_profile).into(settingsDisplayProfileImage, new Callback() {
                        @Override
                        ...
                        public void onError(Exception e) {
                            ...
                            Picasso.get().load(image).placeholder(R.drawable.defualt_image_profile).into(settingsDisplayProfileImage);
                ...
                filePath.putFile(resultUri).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onComplete(@NonNull final Task<UploadTask.TaskSnapshot> task) {
                        ...
                        if(task.isSuccessful()){
                            ...
                            Toast.makeText(SettingsActivity.this,"Saving your Profile Picture to Firebase Storage",Toast.LENGTH_LONG).show();
                            ...
                            Toast.makeText(SettingsActivity.this,"Error occured while uploading your Profile Picture",Toast.LENGTH_LONG).show();
                            loadingBar.dismiss();
                        }
